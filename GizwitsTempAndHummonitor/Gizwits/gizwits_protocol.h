...
* @{
*/
#define PRODUCT_KEY "030a8d23d45d4e699aa8b26ba5b19d4e"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "f461e412ce80415fb4ecd5b3889161a3"
...
* @{
*/
#define buzzer_BYTEOFFSET                    0
#define buzzer_BITOFFSET                     0
#define buzzer_LEN                           1
#define relay_BYTEOFFSET                    0
#define relay_BITOFFSET                     1
#define relay_LEN                           1
#define alarm_mode_BYTEOFFSET                    0
#define alarm_mode_BITOFFSET                     2
#define alarm_mode_LEN                           1

#define temperature_up_RATIO                         0.1
#define temperature_up_ADDITION                      0
#define temperature_up_MIN                           0
#define temperature_up_MAX                           1000
#define temperature_down_RATIO                         0.1
#define temperature_down_ADDITION                      0
#define temperature_down_MIN                           0
#define temperature_down_MAX                           1000
#define humidity_up_RATIO                         0.1
#define humidity_up_ADDITION                      0
#define humidity_up_MIN                           0
#define humidity_up_MAX                           1000
#define humidity_down_RATIO                         0.1
#define humidity_down_ADDITION                      0
#define humidity_down_MIN                           0
#define humidity_down_MAX                           1000
#define temperature_RATIO                         0.1
#define temperature_ADDITION                      0
#define temperature_MIN                           0
#define temperature_MAX                           1000
#define humidity_RATIO                         0.1
#define humidity_ADDITION                      0
#define humidity_MIN                           0
#define humidity_MAX                           1000
/**@} */
...
typedef enum
{
  ...
  EVENT_relay,
  EVENT_alarm_mode,
  EVENT_temperature_up,
  EVENT_temperature_down,
  EVENT_humidity_up,
  EVENT_humidity_down,
...
typedef struct {
  bool valuebuzzer;
  bool valuerelay;
  bool valuealarm_mode;
  float valuetemperature_up;
  float valuetemperature_down;
  float valuehumidity_up;
  float valuehumidity_down;
...
typedef struct {
  ...
  uint8_t flagrelay:1;
  uint8_t flagalarm_mode:1;
  uint8_t flagtemperature_up:1;
  uint8_t flagtemperature_down:1;
  uint8_t flaghumidity_up:1;
  uint8_t flaghumidity_down:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint16_t valuetemperature_up;
  uint16_t valuetemperature_down;
  uint16_t valuehumidity_up;
  uint16_t valuehumidity_down;
} attrVals_t;
