...
* @{
*/
#define PRODUCT_KEY "a40ebf51f9d34ece8e7a71b08addd865"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "c4dc66409bdd4d1798c89663648607b4"
...
* @{
*/
#define fortify_BYTEOFFSET                    0
#define fortify_BITOFFSET                     0
#define fortify_LEN                           1
#define inf_tube_BYTEOFFSET                    1
#define inf_tube_BITOFFSET                     0
#define inf_tube_LEN                           1
#define pyr_BYTEOFFSET                    1
#define pyr_BITOFFSET                     1
#define pyr_LEN                           1
#define alaram_flag_BYTEOFFSET                    2
#define alaram_flag_BITOFFSET                     0
#define alaram_flag_LEN                           1
