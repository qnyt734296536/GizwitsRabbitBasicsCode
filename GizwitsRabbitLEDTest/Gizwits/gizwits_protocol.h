...
* @{
*/
#define PRODUCT_KEY "54bd98055e6e434a8b9b4d2f972b4607"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "b4f15d33558546a39a32b554344c13e1"
...
#define LED1_BITOFFSET                     0
#define LED1_LEN                           1
#define LED2_BYTEOFFSET                    0
#define LED2_BITOFFSET                     1
#define LED2_LEN                           1
#define LED3_BYTEOFFSET                    0
#define LED3_BITOFFSET                     2
#define LED3_LEN                           1
#define LED4_BYTEOFFSET                    0
#define LED4_BITOFFSET                     3
#define LED4_LEN                           1
