...
* @{
*/
#define PRODUCT_KEY "c7940fbfb77c4c1b9e9e7bd74d749919"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "9ff7618a60274a9990f90d4ece537cca"
...
#define relay_LEN                           1
#define control_mode_BYTEOFFSET                    0
#define control_mode_BITOFFSET                     1
#define control_mode_LEN                           1
#define pyr_BYTEOFFSET                    7
#define pyr_BITOFFSET                     0
#define pyr_LEN                           1

#define rgb_r_RATIO                         1
#define rgb_r_ADDITION                      0
#define rgb_r_MIN                           0
#define rgb_r_MAX                           4095
#define rgb_g_RATIO                         1
#define rgb_g_ADDITION                      0
#define rgb_g_MIN                           0
#define rgb_g_MAX                           4095
#define rgb_b_RATIO                         1
#define rgb_b_ADDITION                      0
#define rgb_b_MIN                           0
#define rgb_b_MAX                           4095
/**@} */
